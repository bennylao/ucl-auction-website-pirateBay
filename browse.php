      ...
      <div class="col-md-3 pr-0">
        <div class="form-floating">
          ...
          <select class="form-select" id="items_per_page" name="items_per_page"
            ...
            <option <?php if (isset($_GET['items_per_page']) && $_GET['items_per_page'] == "5") echo "selected"; ?>
                value=5>5
            </option>
            <option <?php if (isset($_GET['items_per_page']) && $_GET['items_per_page'] == "10") echo "selected"; ?>
                value=10>10
            </option>
            <option <?php if (isset($_GET['items_per_page']) && $_GET['items_per_page'] == "25") echo "selected"; ?>
                value=25>25
            </option>
            <option <?php if (isset($_GET['items_per_page']) && $_GET['items_per_page'] == "50") echo "selected"; ?>
                value=50>50
            </option>
          </select>
