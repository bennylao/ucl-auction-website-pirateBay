...
function is_create_auction_input_empty(string $auctionTitle, string $auctionBrand, string $auctionCategory, float $auctionStartPrice, float $auctionReservePrice, string $auctionEndDate)
{
    if (empty($auctionTitle) || empty($auctionBrand) || empty($auctionCategory) || empty($auctionStartPrice) || empty($auctionReservePrice) || empty($auctionEndDate)) {
        return true;
    } else {
        return false;
    }
...
function create_auction(object $conn, int $userid, string $auctionTitle, string $auctionBrand, string $auctionDetails, string $auctionCategory,
