...
function create_auction(object $conn, int $userid, string $auctionTitle, string $auctionDetails, string $auctionCategory,
                        float $auctionStartPrice, float $auctionReservePrice, string $auctionEndDate)
{
    set_auction($conn, $userid, $auctionTitle, $auctionDetails, $auctionCategory, $auctionStartPrice,
