...
<?php require_once("config_database.php") ?>
  ...
  <div class="container">
    ...
    <!-- end search specs bar -->
      ...
      $count_item_query = "SELECT COUNT(DISTINCT itemTitle)
            FROM items i
            LEFT JOIN bidHistory b ON i.itemId = b.itemId
            WHERE b.userId = $currentUserId
            AND (i.itemTitle LIKE '$keyword' or i.category LIKE '$keyword' or i.description LIKE '$keyword' or i.brand LIKE '$keyword')
    ...
    <nav aria-label="Search results pages" class="mt-5">
      <div class="row">
        ...
        <div class="col-auto ml-auto">
          <form class="form-inline" method="GET" action="mybids.php">
  ...
  <script>
      function handleSubmit(event) {
          ...
          window.location.href = 'mybids.php?search_keyword=' + encodeURIComponent(searchKeyword) +
