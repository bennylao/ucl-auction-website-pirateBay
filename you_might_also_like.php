...
?>
  ...
  <h2 class="my-3">Others who bid on your bidding items also bid...</h2>
  <h5 class="my-3">Based on the items other bidders also bid on.</h5>

  <form action="you_might_also_like.php" id="filter_bar" method="GET">
    <div class="row">
  ...
  <!-- end search specs bar -->
    ...
    $count_item_query = "SELECT COUNT(DISTINCT i.itemId) 
                            FROM items i
                            INNER JOIN bidHistory b ON i.itemId = b.itemId
                            WHERE b.userId IN (
                            SELECT b.userId FROM bidHistory b 
    ...
    <nav aria-label="Search results pages" class="mt-5">
      <div class="row">
        ...
        <a class="page-link" href="you_might_also_like.php?' . $querystring . 'page=' . ($curr_page - 1) . '" aria-label="Previous">
        ...
        <span class="sr-only">Previous</span>
              ...
              for ($i = $low_page; $i <= $high_page; $i++) {
                  ...
                  // Do this in any case
                  echo('<a class="page-link" href="you_might_also_like.php?' . $querystring . 'page=' . $i . '">' . $i . '</a></li>');
              }

              if ($curr_page < $max_page) {
                  echo('<li class="page-item">
        <a class="page-link" href="you_might_also_like.php?' . $querystring . 'page=' . ($curr_page + 1) . '" aria-label="Next">
        ...
        <div class="col-auto ml-auto">
          <form class="form-inline" method="GET" action="you_might_also_like.php">
  ...
  <script>
      function handleSubmit(event) {
          ...
          window.location.href = 'you_might_also_like.php?search_keyword=' + encodeURIComponent(searchKeyword) +
